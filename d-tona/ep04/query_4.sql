...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2016-11-01' and '2017-05-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2016-12-01' and '2017-06-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-01-01' and '2017-07-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-02-01' and '2017-08-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-03-01' and '2017-09-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-04-01' and '2017-10-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-05-01' and '2017-11-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-06-01' and '2017-12-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-07-01' and '2018-01-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-08-01' and '2018-02-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-09-01' and '2018-03-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-10-01' and '2018-04-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-11-01' and '2018-05-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id
...
from (
        ...
        from tb_orders as t1
            ...
            left join tb_products as t4 on t2.product_id = t4.product_id
            left join tb_order_reviews as t5 on t1.order_id = t5.order_id
        where t1.order_approved_at between '2017-12-01' and '2018-06-01'
            and t1.order_status = 'delivered'
        group by t2.seller_id
    ) as t1
    left join tb_sellers as t2 on t1.seller_id = t2.seller_id